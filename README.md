...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-live-recording-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15249&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-live-recording-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-live-recording` can be installed with:

```
conda install napari-live-recording
```

It is possible to list all of the versions of `napari-live-recording` available on your platform with:
